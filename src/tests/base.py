...
def device_test():
    ...
    #list of actuators
    device2 = actuator.Actuator(physic_id = "AB2489DE", name = "Actionneur zombie apocalypse",current_state="off", coordX = 65, coordY = 330)
    actu1 = actuator.Actuator(physic_id = "AE2489DB", name = "Actionneur fumée bureau", current_state="off",coordX = 500, coordY = 330)
    actu2 = actuator.Actuator(physic_id = "AC2489DA", name = "Actionneur lampe cave", current_state="off",coordX = 350, coordY = 100)
    ...
    player13 = position.Position(physic_id = "BE458ECD", name = "Equipe 1 joueur 6", current_state = {"coordX":60,"coordY":500}, coordX = 60, coordY = 500, team = 1)
    # player14 = position.Position(physic_id = "DE4265DE", name = "Equipe 1 joueur 3", current_state = {"coordX":70,"coordY":500}, coordX = 70, coordY = 500, team = 1)
    # player15 = position.Position(physic_id = "AC3542FE", name = "Equipe 1 joueur 4", current_state = {"coordX":60,"coordY":510}, coordX = 60, coordY = 510, team = 1)
    # player16 = position.Position(physic_id = "FDEE42CD", name = "Equipe 1 joueur 5", current_state = {"coordX":50,"coordY":510}, coordX = 50, coordY = 510, team = 1)
    ...
    player22 = position.Position(physic_id = "AB25FECD", name = "Equipe 2 joueur 2", current_state = {"coordX":600,"coordY":60}, coordX = 600, coordY = 60, team = 2)
